...
public:
	SwcSnapshotTableModel(
		std::vector<proto::SwcSnapshotMetaInfoV1> &swcSnapshots,
				...
				case 0:
					return QString::fromStdString(
						google::protobuf::util::TimeUtil::ToString(
							info.createtime()));
				case 1:
					return QString::fromStdString(info.creator());
				case 2:
					return QString::fromStdString(
						info.swcsnapshotcollectionname());
				case 3:
...
public:
	explicit EditorSwcSnapshot(const std::string &swcName,
