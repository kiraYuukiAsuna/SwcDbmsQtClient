...
EditorBatchManageSwc::EditorBatchManageSwc(
	const std::vector<std::string>& swcUuidList, QWidget* parent)
	: QDialog(parent),
	  ui(new Ui::EditorBatchManageSwc),
	...
	connect(ui->DeleteSelectedSwc, &QPushButton::clicked, this, [this] {
		QMessageBox::StandardButton reply =
			QMessageBox::question(this, "Delete Selected Swc",
	...
	connect(
		ui->ChangePermissionOfSelectedSwc, &QPushButton::clicked, this, [this] {
...
EditorBatchManageSwc::~EditorBatchManageSwc() { delete ui; }
