...
QT_BEGIN_NAMESPACE
namespace Ui {
	class EditorSwcIncrementRecord;
}
QT_END_NAMESPACE
...
public:
	SwcIncrementRecordTableModel(
		std::vector<proto::SwcIncrementOperationMetaInfoV1> &swcIncrements,
				...
				case 0:
					return QString::fromStdString(
						google::protobuf::util::TimeUtil::ToString(
							info.createtime()));
				case 1:
					return QString::fromStdString(info.startsnapshot());
				case 2:
					return QString::fromStdString(
						info.incrementoperationcollectionname());
				case 3:
					return QString::fromStdString(info.base()._id());
				case 4:
					return QString::fromStdString(
						info.base().dataaccessmodelversion());
				case 5:
					return QString::fromStdString(info.base().uuid());
				default:
					return {};
			}
		}
...
public:
	explicit EditorSwcIncrementRecord(const std::string &swcUuid,
