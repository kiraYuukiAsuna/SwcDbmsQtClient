...
public:
    SwcAttachmentTableModel(std::vector<proto::SwcNodeDataV1>& swcData, QObject *parent = nullptr)
...
QT_BEGIN_NAMESPACE
namespace Ui { class EditorSwcAttachment; }
QT_END_NAMESPACE
...
public:
    explicit EditorSwcAttachment(const std::string& swcUuid, QWidget *parent = nullptr);
