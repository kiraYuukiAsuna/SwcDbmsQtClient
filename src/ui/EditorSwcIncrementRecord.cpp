...
EditorSwcIncrementRecord::EditorSwcIncrementRecord(const std::string& swcUuid,
												   QWidget* parent)
	: QDialog(parent),
	  ui(new Ui::EditorSwcIncrementRecord),
	  m_SwcUuid(swcUuid) {
	ui->setupUi(this);

	connect(ui->DetailBtn, &QPushButton::clicked, this, [&]() {
		QMessageBox::information(this, "Info",
								 "Using [Version Control] To Access History "
								 "Swc Version at AnyTime!");
	});
...
EditorSwcIncrementRecord::~EditorSwcIncrementRecord() { delete ui; }
