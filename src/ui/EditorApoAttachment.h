...
public:
	SwcAttachmentApoTableModel(std::vector<proto::SwcAttachmentApoV1> &swcData,
			...
			switch (index.column()) {
				...
				case 1:
					return QString::fromStdString(
						std::to_string((int)info.x()));
				case 2:
					return QString::fromStdString(
						std::to_string((int)info.y()));
				case 3:
					return QString::fromStdString(
						std::to_string((int)info.z()));
				case 4:
					return "";	// 显示颜色的名称
				default:
					return {};
...
public:
	explicit EditorApoAttachment(const std::string &swcUuid,
