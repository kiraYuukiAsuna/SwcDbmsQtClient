...
class Neuron {
	...
	void printSWC(Segment *s,std::ofstream & out );

	void printDXF(Segment *s,std::ofstream & out);

	void printDXFint(Segment *s,std::ofstream & out);

	void printFatherDXF(Segment *s);

	void printWRL(Segment *s, std::ofstream & out );
	...
	int LookForFileType(std::ifstream* in);
	
	void saveTree(Segment *s,std::ofstream & treeout);
	bool lookFor(const char * string,std::ifstream* in);
...
public:
	...
	void printDXF(Segment * s, Segment *t, std::ofstream & out);
