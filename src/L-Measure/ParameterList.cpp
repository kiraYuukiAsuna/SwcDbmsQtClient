...
void ParameterList::readParameter(const char * fileNam){
	int i,index,type;
...
double ParameterList::getParameter(const char * paramName){
	char *c,name[50];
...
int ParameterList::isPresent(const char * paramName){
	char *c,name[50];
	strcpy(name,paramName);
