...
public:
	...
	// Problem - gcc on Mac makes operator[] ambiguous when cast operator is
	// included const ELT& operator[](index_type i) const {return data[i];} ELT&
	// operator[](index_type i) {return data[i];}
