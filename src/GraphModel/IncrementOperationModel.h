...
public:
    ...
    virtual QString caption() const override { return "IncrementOperationDelegateModel";};
    ...
    virtual QString name() const override { return "IncrementOperationDelegateModel"; };
